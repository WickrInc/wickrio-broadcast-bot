  ...
  constructor({ messageService }) {
    ...
    if (
      ...
      if (
        ...
        const reply = `Hey this bot is just for announcements and can't respond to you personally, or ${this.messageService.userEmail} is not authorized to use this bot. If you have a question, please get a hold of us at support@wickr.com or visit us at support.wickr.com. Thanks, Team Wickr`
